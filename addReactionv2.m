function [model,rxnIDexists] = addReactionv2(model,rxnName,metaboliteList,stoichCoeffList,revFlag,lowerBound,upperBound,objCoeff,subSystem,grRule,geneNameList,systNameList,checkDuplicate)
%addReactionv2 Add a reaction to the model or modify an existing reaction
%
...
if (parseFormulaFlag)
    ...
    [metaboliteList,stoichCoeffList,revFlag] = rxnParser(rxnFormula);
end

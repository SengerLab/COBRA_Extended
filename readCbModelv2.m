function model = readCbModelv2(fileName,defaultBound,fileType,modelDescription,compSymbolList,compNameList)
...
% Convert
model = convertSBMLToCobrav2(modelSBML,defaultBound,compSymbolList,compNameList);

function sbmlModel = convertCobraToSBMLv2(model,sbmlLevel,sbmlVersion,compSymbolList,compNameList,debug_function)
...
if ~exist('compSymbolList','var') || isempty(compSymbolList)
    ...
    compNameList = {'Cytoplasm','Mitochondrion','Vacuole','Peroxisome','Extracellular','Pool','Golgi','Endoplasmic_reticulum','Nucleus','Periplasm','Lysosome','Thylakoid'};
end
...
str = strrep(str,'<','&lt;');
str = strrep(str,'"','&quot;');
% added by Hadi, 6-19-2013
str = strrep(str,'>','_GTS_');
